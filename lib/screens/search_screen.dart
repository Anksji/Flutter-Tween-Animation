import 'package:tween_animation_ui/common.dart';
...
class Body extends StatelessWidget {
  ...
  Route delayedRoute(int index) {
    return PageRouteBuilder(
      pageBuilder: (_, __, ___) => DetailScreen(index),
...
class _CustomCoffeeAppBarState extends State<CustomCoffeeAppBar> {
  ...
  final String appBarSearchText = "Searching for ...";
  @override
  void initState() {
...
class PuppyTransition extends StatelessWidget {
